...
- Once there is one replica in a disk using a backing image, no matter the replica current state, the backing image file in this disk cannot be cleaned up.

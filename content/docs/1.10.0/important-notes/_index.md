...
- [Interrupt Mode Support](../v2-data-engine/features/interrupt-mode): Enables interrupt mode in the V2 Data engine to reduce CPU usage. Key considerations when configuring this feature:

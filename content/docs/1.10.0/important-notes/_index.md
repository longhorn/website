...
Longhorn now support volume and snapshot cloning for v2 data engine volumes.
For more information, see [Volume Clone Support](../v2-data-engine/features/volume-clone) for more information.

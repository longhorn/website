...
This page summarizes the expected behavior differences between Longhorn data engines and provides a feature support matrix for the Longhorn v1.12.0 documentation set.

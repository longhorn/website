...
The helm chart will install NetworkPolicy objects when the [networkPolicies.enabled value](https://github.com/longhorn/longhorn/blob/v1.6.0/chart/values.yaml) is set to `true`.
The manifests of these objects can be viewed in the [git repository](https://github.com/longhorn/longhorn/tree/v1.6.0/chart/templates/network-policies).

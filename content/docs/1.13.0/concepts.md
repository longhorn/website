...
- [1. Design](#1-design)
  ...
  - [1.3. V1 and V2 Data Engine Data Paths](#13-v1-and-v2-data-engine-data-paths)
    - [1.3.1. V1 Data Engine](#131-v1-data-engine)
    - [1.3.2. V2 Data Engine](#132-v2-data-engine)
  - [1.4. Advantages of a Microservices-Based Design](#14-advantages-of-a-microservices-based-design)
  - [1.5. CSI Driver](#15-csi-driver)
  - [1.6. CSI Plugin](#16-csi-plugin)
  - [1.7. The Longhorn UI](#17-the-longhorn-ui)
...
## 1.3. V1 and V2 Data Engine Data Paths

### 1.3.1. V1 Data Engine
...
## 1.4. Advantages of a Microservices-Based Design

...
### Deprecate `longhorn.io/v1beta1` API version

Since v1.9.0, the longhorn.io/v1beta1 API version has been deprecated and will be removed in v1.10.0. During the Longhorn system upgrade, custom resources using longhorn.io/v1beta1 will be automatically migrated to longhorn.io/v1beta2.

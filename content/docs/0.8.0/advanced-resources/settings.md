...
To configure Longhorn before installing it, see [this section](../advanced-resources/customizing-default-settings) for details.
...
The target used for backup. NFS and S3 are supported. See [Snapshot and Backup](../../concepts/snapshots) for details.

#### Backup Target Credential Secret
> Example: `s3-secret`

The Kubernetes secret associated with the backup target. See [Snapshot and Backup](../../concepts/snapshots) for details.

#### Backupstore Poll Interval
> Example: `300`

The interval in seconds to poll the backup store for updating volumes' **Last Backup** field. Set to 0 to disable the polling. See [Disaster Recovery Volume](../../concepts/disaster-recovery-volumes) for details.
...
See [Taint Toleration](../taint-toleration) for details.
...
See [Multiple Disks Support](../multidisk#configuration) for details.
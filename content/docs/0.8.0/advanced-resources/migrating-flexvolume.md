...
1. [Back up existing volumes](../../backup-and-restore/create-a-backup).
...
3. Restore each volume. This [procedure](../../backup-and-restore/restore-statefulset) is tailored to the StatefulSet workload, but the process is approximately the same for all workloads.
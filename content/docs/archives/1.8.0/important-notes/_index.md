...
This issue does not affect installations and upgrades performed using the [Longhorn Helm repository](https://charts.longhorn.io/). For more details, refer to the [Install with Helm](https://longhorn.io/docs/archives/1.8.0/deploy/install/install-with-helm/) section of the official documentation.

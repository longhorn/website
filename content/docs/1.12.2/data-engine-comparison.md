...
This page summarizes the expected behavior differences between the Longhorn data engines and data layouts, and provides a feature support matrix for the Longhorn v1.12.2 documentation set.

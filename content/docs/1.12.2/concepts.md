...
- **Active instances**:  
  V2 volumes do not support live upgrades between Longhorn v1.12 patch releases and must be detached before upgrading, see [V2 Data Engine/Longhorn System Upgrade](../important-notes/#longhorn-system-upgrade).
